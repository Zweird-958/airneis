...
export class Migration20240521122518 extends Migration {
  ...
  async down(): Promise<void> {
    this.addSql('create table "messages" ("id" uuid not null default gen_random_uuid(), "created_at" timestamptz(6) not null default now(), "updated_at" timestamptz(6) not null default now(), "email" text not null, "subject" text not null, "description" text not null, constraint "contact_pkey" primary key ("id"));');
